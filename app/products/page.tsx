    ...
    <main className="relative">
      ...
      <div className="w-full min-h-screen max-w-[1400px] mx-auto px-8 py-24 relative z-10">
        <div className={`max-w-4xl mx-auto transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          ...
          {/* Product 1 */}
          <div className="bg-black/60 backdrop-blur-lg rounded-2xl p-8 border border-white/10 mb-12 shadow-lg transition-all duration-700 delay-100 transform hover:border-white/20">
          ...
          {/* Product 2 */}
          <div className="bg-black/60 backdrop-blur-lg rounded-2xl p-8 border border-white/10 mb-12 shadow-lg transition-all duration-700 delay-200 transform hover:border-white/20">
            <div className="flex items-center mb-6">
